...
\begin{document}
    ...
    \sectionpart{Projects}
       \begin{itemize}
     	...
     	\item Xen - Personal/Portfolio, Website Built With Rust, Rocket, Javascript (Technically No-Javascript), Tailwind CSS And \LaTeX{}. \textit{August 2021 to September 2021}
     	...
     	\item DBench -  Dockerized `dbench` Image Inspired by Leeliu/DBench. Improvements Over Other `dbench` FIO - IOENGINE - Being Able to Set The `ioengine` Can Prevent Weird Situations Where Direct Looks Faster than Buffered Writes. \textit{September 2021 to September 2021}    	
       \end{itemize}   
